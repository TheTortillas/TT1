...
\begin{document}
	...
	%\input{frontmatter/technical_document/technical_document}
	...
	\appendix
		\include{appendages/appendixA/appendixA}
		\include{appendages/appendixB/appendixB}
		\include{appendages/appendixC/appendixC}
