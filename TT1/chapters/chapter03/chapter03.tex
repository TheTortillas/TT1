...
\begin{figure}[H]
	...
	\begin{minipage}{0.32\textwidth}
		...
		\end{tikzpicture}
	\end{minipage}
\caption[Discretización de una función continua]{Proceso de discretización de una función continua $f(x)$. A la izquierda, se muestra la función continua en el intervalo de periodo $T$. Al centro, se representa la aproximación mediante particiones uniformes del intervalo con paso $\Delta x$, evaluando la función en puntos equiespaciados. A la derecha, se ilustra la señal discreta resultante, compuesta por los valores $f_k = f(k\Delta x)$. \textit{Fuente: Elaboración propia.}}
